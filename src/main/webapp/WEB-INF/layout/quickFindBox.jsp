...
<div class="ui-widget infoBoxContainer">
    ...
    <div class="ui-widget-content infoBoxContents" style="text-align: center;">
        <form name="quick_find" action="http://shadowfax/oscommerce2/advanced_search_result.php" method="get">
            ...
            <br />
            <a href="http://shadowfax/oscommerce2/advanced_search.php"><strong>Advanced Search</strong></a>
        </form>
    </div>
</div>
