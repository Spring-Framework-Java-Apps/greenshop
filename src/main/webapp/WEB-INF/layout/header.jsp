...
<div id="header" class="grid_24">
    ...
    <div id="headerShortcuts">
        <span class="tdbLink">
            <a id="tdb1" href="<c:url value="/shoppingCart" />">Cart Contents<c:if test="${!transientBasket.emptyCart}"> (<c:out value="${transientBasket.size}" />)</c:if></a>
        </span>
        <script type="text/javascript">$("#tdb1").button({icons:{primary:"ui-icon-cart"}}).addClass("ui-priority-secondary").parent().removeClass("tdbLink");</script>
        <span class="tdbLink">
            <a id="tdb2" href="<c:url value="/checkout/shipping" />">Checkout</a>
        </span>
        ...
        <span class="tdbLink">
            <a id='tdb3' href='<c:url value="/account"/>'>My Account</a>
        </span>
