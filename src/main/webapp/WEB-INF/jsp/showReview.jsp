...
<div class="contentContainer">
    ...
    <div style="float: right; width: 120px; text-align: center;">
        <a href="<c:url value="/product/${product.productDescription.product.id}" />">
            <img src="images/<c:out value="${product.productDescription.product.image}"/>"
                 ...
                 title="<c:out value="${product.productDescription.name}"/>" width="100" height="80" hspace="5" vspace="5" />
        </a>
        <p>
            <span class="tdbLink">
        ...
        <div class="contentText">
            <c:out value="${reviewDescription.reviewText}"/><br />
            <br />
            <i>
                Rating:
                <c:choose>
    ...
    <div class="buttonSet">
        ...
        <span class="tdbLink">
            <a id="tdb6" href="<c:url value="/product/reviews/${product.productDescription.product.id}"/>">Back</a>
        </span>
