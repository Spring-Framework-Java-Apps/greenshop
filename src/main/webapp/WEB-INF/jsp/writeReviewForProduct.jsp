    ...
    <div class="contentContainer">
        ...
        <div style="float: right; width: 120px; text-align: center;">
            <a href="<c:url value="/product/${product.productDescription.product.id}"/>">
                <img src="images/<c:out value="${product.productDescription.product.image}"/>"
                     alt="<c:out value="${product.productDescription.name}"/>"
                     title="<c:out value="${product.productDescription.name}"/>"
                     width="100" height="80" hspace="5" vspace="5" />
            </a>
            <p>
                <span class="tdbLink">
                    <a id="tdb5" href="<c:url value="/shoppingCart/add/${product.productDescription.product.id}"/>">Add to Cart</a>
                </span>
        ...
        <div class="buttonSet">
            ...
            <span class="tdbLink">
                <a id="tdb7" href="<c:url value="/product/${product.productDescription.product.id}"/>">Back</a>
            </span>
