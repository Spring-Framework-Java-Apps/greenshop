                ...
                <td width="25%" valign="top">
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                        <tr class="infoBoxHeading">
                            <td class="infoBoxHeading"><strong>Burgenland</strong></td>
                        </tr>
                    </table>
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                        <tr>
                        ...
                        <tr>
                            <td class="infoBoxContent"><br />Zones Name:<br />Burgenland (BL)</td>
                        </tr>
                        <tr>
                            <td class="infoBoxContent"><br />Country: Austria</td>
                        </tr>
                    </table>
                </td>
            </tr>
