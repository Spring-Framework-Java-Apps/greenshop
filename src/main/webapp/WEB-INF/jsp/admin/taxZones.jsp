                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                        ...
                        <c:if test="${taxZone.id == thisTaxZone.id}">
                            <tr id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='http://localhost/oscommerce2/admin/geo_zones.php?zpage=1&zID=2&action=list'">
                                <td class="dataTableContent"><a href="http://localhost/oscommerce2/admin/geo_zones.php?zpage=1&zID=2&action=list"><img src="resources/admin/images/icons/folder.gif" border="0" alt="Folder" title="Folder" /></a>&nbsp;${taxZone.name}</td>
                        ...
                        <c:if test="${taxZone.id != thisTaxZone.id}">
                            <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='<c:url value="/admin/taxZones/${taxZone.id}"/>'">
                                <td class="dataTableContent"><a href="http://localhost/oscommerce2/admin/geo_zones.php?zpage=1&zID=1&action=list"><img src="resources/admin/images/icons/folder.gif" border="0" alt="Folder" title="Folder" /></a>&nbsp;${taxZone.name}</td>
