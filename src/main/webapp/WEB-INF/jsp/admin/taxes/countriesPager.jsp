...
<tr>
    ...
    <td class="smallText" align="right">
        <form name="pages" action="<c:url value="/admin/countries"/>" method="get"><c:choose>
            <c:when test="${countries.hasPrevious()}"><a href="<c:url value="/admin/countries?page=${countries.previousPageable().pageNumber}"/>" class="splitPageLink">&lt;&lt;</a></c:when>
            ...
            <c:when test="${countries.hasNext()}"><a href="<c:url value="/admin/countries?page=${countries.nextPageable().pageNumber}"/>" class="splitPageLink">&gt;&gt;</a></c:when>
            <c:otherwise>&gt;&gt;</c:otherwise>
        </c:choose></form>
    </td>
</tr>