...
<div class="contentContainer">
  ...
  <div class="contentText">
    ...
    This is the currently selected billing address where the invoice to this order will be delivered to.  </div>
...
<h2>Address Book Entries</h2>
  ...
  <div class="contentText">
    Please use the following form to create a new billing address to use for this order.  </div>
    ...
    <div style="float: left; width: 60%; padding-top: 5px; padding-left: 15%;">
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td align="center" width="33%" class="checkoutBarCurrent"><a href="http://shadowfax/oscommerce2/checkout_payment.php" class="checkoutBarCurrent">Payment Information</a></td>
