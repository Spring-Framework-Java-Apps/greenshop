...
<form name="account_notifications" action="http://localhost/oscommerce2/account_notifications.php" method="post"><input type="hidden" name="formid" value="0923a4ea590b42438f4ff4a9af74d302" /><input type="hidden" name="action" value="process" />
<div class="contentContainer">
  ...
  <div class="contentText">
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="30"><input type="checkbox" name="product_global" value="1" onclick="checkBox('product_global')" /></td>
